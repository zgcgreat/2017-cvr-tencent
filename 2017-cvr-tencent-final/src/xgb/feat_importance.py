...
if __name__ == '__main__':
    train = pd.read_csv("../../data/train_data/train3.csv")
    ...
    # train = train[train['clickTime'] >= 24000000]
    #
    # train = train[train['clickTime'] < 30000000]
    #
    # test = train[train['clickTime'] >= 29000000]
    # train = train[train['clickTime'] < 29000000]

    # print(len(train), len(test), len(train) + len(test))
    #
    # train['clickTime'] = train['clickTime'].apply(hour)
    # test['clickTime'] = test['clickTime'].apply(hour)
